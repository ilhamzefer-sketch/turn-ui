import type { WalletBalance, WalletTopUpOptions, WalletTopUpRequest, WalletTransactionPage } from "./contracts";
...
export const walletApi = {
  ...
  createTopUpRequest: (amountAzn: number) => apiRequest<WalletTopUpRequest>("/api/users/me/wallet/top-up-requests", { method: "POST", body: JSON.stringify({ amountAzn }) }),
