...
export function BusinessGovernancePage() {
  ...
  usePageMeta("Sahiblik və icazələr — NövbəTime", "Biznes primary owner sahibliyinin auditli ötürülməsi.");
